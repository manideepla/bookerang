...
CREATE TABLE `books` (
  ...
  CONSTRAINT `books_ibfk_1` FOREIGN KEY (`borrower`) REFERENCES `users` (`username`),
  CONSTRAINT `books_ibfk_2` FOREIGN KEY (`owner`) REFERENCES `users` (`username`),
...
-- Dump completed on 2025-02-02 19:19:07
